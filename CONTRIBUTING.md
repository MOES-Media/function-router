# Contributing to Function Router

Thank you for your interest in contributing to Function Router!  
...
```sh
git add .
git commit -m "feat(core): add handler merging"
...
Thank you for helping make Function Router better!